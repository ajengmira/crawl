            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Test</h4>
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>test/action_test_crawl" method="post">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="url" placeholder="Example: https://fabelio.com/ip/giselle-armchair.html" required>
                                                </div>
                                            </div>
                                            <!--div class="form-group">
